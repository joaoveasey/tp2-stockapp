...
namespace StockApp.Domain.Entities
{
    public class Product
    {
        ...
        public void ValidateDomain(string name, string description, decimal price, int stock, string image)
        {
            ...
            DomainExceptionValidation.When(image.Length < 7,
                "Invalid image, too short, minumum 5 characters.");

            DomainExceptionValidation.When(image.Length > 200,
                "Invalid image, too long, maximum 200 characters.");
        }       
        #endregion
    }
}